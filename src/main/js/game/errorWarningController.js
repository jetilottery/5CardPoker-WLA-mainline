...
define([
    ...
    function onGameParametersUpdated() {
        ...
        gameUtils.setButtonHitArea(gr.lib._warningContinueButton, config.gladButtonImgName.warningContinueButton);
        
        warningExitButton = new gladButton(gr.lib._warningExitButton, config.gladButtonImgName.warningExitButton, scaleType);
        gameUtils.setButtonHitArea(gr.lib._warningExitButton, config.gladButtonImgName.warningExitButton);
        
        errorExitButton = new gladButton(gr.lib._errorExitButton, config.gladButtonImgName.errorExitButton, scaleType);	
        gameUtils.setButtonHitArea(gr.lib._errorExitButton, config.gladButtonImgName.errorExitButton);
        
		winBoxErrorButton = new gladButton(gr.lib._winBoxErrorExitButton, config.gladButtonImgName.winBoxErrorExitButton, scaleType);
        gameUtils.setButtonHitArea(gr.lib._winBoxErrorExitButton, config.gladButtonImgName.winBoxErrorExitButton);
        ...
        if(gr.lib._winBoxError){
            ...
            gameUtils.setTextStyle(gr.lib._warningExitText, config.style.buttonTextStyle);
        ...
        gameUtils.setTextStyle(gr.lib._warningContinueText, config.style.buttonTextStyle);
        ...
        gameUtils.setTextStyle(gr.lib._errorExitText, config.style.buttonTextStyle);
        ...
        if (gr.lib._winBoxErrorExitText) {
            gameUtils.setTextStyle(gr.lib._winBoxErrorExitText,config.style.buttonTextStyle);
