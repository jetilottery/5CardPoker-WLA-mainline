define([
    ...
    function setStyle() {
        ...
        const percent = bodyHeight / height * 100 + '%';
        document.getElementById("gameRulesArticle").style.height = percent;
        // document.getElementById("gameRulesArticle").style.top = headerHeight+'px';
        document.getElementById("paytableArticle").style.height = percent;
    ...
    msgBus.subscribe('disableButtonInfo', disableConsole);
    msgBus.subscribe('enableButtonInfo', enableConsole);

    // msgBus.subscribe('disableConsole', disableConsole);
    msgBus.subscribe('enableConsole', enableConsole);
    // msgBus.subscribe('allRevealed', enableConsole);
    msgBus.subscribe('jLottery.beginNewGame', enableConsole);
